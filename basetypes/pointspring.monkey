...
Public	
	'/**
	 '* Adds a spring between the Point And a Sprite.
	 '* 
	 ...
	 '*/
	 Method New(sprite:FlxExtendedSprite, point:FlxPoint, retainVelocity:Bool = False, tension:Float = 0.1, friction:Float = 0.95, gravity:Float = 0)
		Self.sprite = sprite
	...
	'/**
	 ...
	 '*/
	Method Update:Void()
		_dx = _point.x - sprite.SpringX
		_dy = _point.y - sprite.SpringY 
