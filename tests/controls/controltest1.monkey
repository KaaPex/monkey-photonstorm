...
'		Add(header);
		...
		FptFlxControl.Create(player, FptFlxControlHandler.MOVEMENT_INSTANT, FptFlxControlHandler.STOPPING_INSTANT)
		FptFlxControl.player1.SetStandardSpeed(100, false)
