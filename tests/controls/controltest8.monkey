...
Class Objects Extends FlxGame
	...
	Method New()		
		Super.New(320, 256, GetClass("ControlTest8"), 1, 60, 60)
		
		Print ControlTest8.title
		Print ControlTest8.description
		Print ControlTest8.instructions		
...
Class ControlTest8 Extends FlxState
...
Public
	'//	Common variables
	Global title:String = "Controls 8"
	Global description:String = "Thrust with Gravity"
